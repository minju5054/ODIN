    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[{
                ...
                'ignore_distance_m': 2.2,
                'ignored_robot_radius_m': 0.36,
                'range_tolerance_m': 0.30,
                'angle_margin_rad': 0.12,
        ...
        Node(
            package='odin_navigation',
            executable='robot_3_speed_policy',
            name='robot_3_speed_policy',
            output='screen',
            parameters=[{
                'use_sim_time': use_sim_time,
                'mission_policy_topic': '/ai/mission_policy',
                'controller_set_parameters_service': '/robot_3/controller_server/set_parameters',
                'velocity_smoother_set_parameters_service': '/robot_3/velocity_smoother/set_parameters',
                'normal_linear_speed_mps': 0.26,
                'stealth_linear_speed_mps': 0.40,
                'angular_speed_radps': 0.85,
            }],
        ),
        *_nav2_nodes(params, use_sim_time),
        Node(
            ...
            parameters=[{
                ...
                'selected_path_waypoint_spacing_m': 1.4,
                'selected_path_goal_tolerance_m': 0.35,
                'selected_path_sync_timeout_sec': 1.0,
            }],
        ),
        Node(
            package='odin_navigation',
